...
namespace Sys.Model
{
    ...
    public partial class Mes_Tec_ProductInfo : Entity
    {
        ...
        public class _
        {
			...
			/// _0-批次追溯;2-单件追溯
			/// </summary>
            public readonly static Field TraceProperty = new Field("TraceProperty", "Mes_Tec_ProductInfo", "_0-批次追溯;2-单件追溯");
            /// <summary>
			/// _0-物料;1-成品
			/// </summary>
            public readonly static Field MaterialClass = new Field("MaterialClass", "Mes_Tec_ProductInfo", "_0-物料;1-成品");
            /// <summary>
			/// 
			/// </summary>
