...
namespace Sys.Dao
{
    public class MesTraInStockDao : BaseDao
    {
        public static MesTraInStockDao _Instance = null;

        public static MesTraInStockDao Instance
        {
            get
            {
                if (_Instance == null)
                {
                    _Instance = new MesTraInStockDao();
                }
                return _Instance;
            }
        }
