...
namespace MES.ManagementApp.Controllers
{
    ...
    public partial class CommonController :BaseController
    {
        ...
        private const string CreateErrorMessage = "第{0}行生成新样品编码出错";
      ...
      [HttpPost]
        public ActionResult ImportExcelMain()
        {
            ...
            curUserId = Request.Params["LoginUser"];
            ...
            try
            {
                ...
                if (businessType == "TecProcessBom") //配套明细表
                {
                    ...
                    //errorList = this.Import_Rc_SampleInfo(dataTable);
                }
        ...
        /// </summary>
        /// <returns>文件是否保存成功</returns>
        private bool CheckAndSaveYqFile(out string message, out string fileFullName)
        {
            string fileName = string.Empty;
            string YqTempFolder = "~/uploads/ResultTemp/";
            return this.CheckAndSaveFile(YqTempFolder, out message, out fileFullName, out fileName);
        }
       ...
       /// <returns>是否成功</returns>
        ...
        //private IList<ImportMessageModel> Import_Rc_SampleInfo(DataTable dtData)
        //{
